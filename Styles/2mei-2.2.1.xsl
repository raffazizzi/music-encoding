...
CHANGES:  (v. 1.1)
          1. Fixed bug that kept horizontal offsets of hairpins from
             being recorded.
          2. MusicXML work and identification elements now used to
             create an MEI sourcedesc/source element.
          3. Fixed bug in the handling of control elements, such as
             pedal.
          4. Removed code which generated msrest elements.
          5. Improved the handling of ornaments.
          6. Improved the handling of key signatures and transposing
             staves.
          7. Improved the insertion of space into cross-staff voices.
          8. Improved the handling of MusicXML forward elements.

          (v. 2.0)
          1. Now generates MEI 1.9b conformant file.
          2. Fixed bug in character entity output.
          
          (v. 2.2.1)
          1. Now generates file conformant with MEI 1.9b RNG including
...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="score-timewise" mode="stage1">
    <mei version="1.9b" xmlns:xlink="http://www.w3.org/1999/xlink">
              ...
              <scoredef>
                ...
                <xsl:if test="descendant::measure[1]/part/attributes[1]/time">
                  ...
                  <xsl:choose>
                    ...
                    <xsl:when
                      test="descendant::part[attributes[1]/time/senza-misura][1]/attributes/time/senza-misura">
                ...
                <xsl:if test="descendant::part/attributes[not(transpose)]/key">
                  <xsl:variable name="keysig">
                    <xsl:value-of
                      select="descendant::part[attributes[not(transpose) and key]][1]/attributes[1]/key/fifths"
                    />
                  </xsl:variable>
                  <xsl:choose>
...
following-sibling::measure[1][attributes[not(preceding-sibling::note)]] -->
        ...
        <dir>
          ...
          <xsl:choose>
            <xsl:when test="words/@xml:lang">
              <xsl:attribute name="xml:lang">
                <xsl:value-of select="words/@xml:lang"/>
              </xsl:attribute>
            </xsl:when>
            <!-- <xsl:otherwise>
            ...
            <xsl:when
              ...
              <rend>
                <xsl:if test="words/@font-family">
                  <xsl:attribute name="fontfam">
                    <xsl:value-of select="normalize-space(words/@font-family)"/>
                  </xsl:attribute>
                </xsl:if>
  ...
  <xsl:template match="note/notations/slur[@type='start']" mode="stage1">
    <!-- With version 1.8 MEI labels phrase marks and slurs as 'slur'. -->
    <slur>
      <xsl:attribute name="tstamp.ges">
        <xsl:for-each select="ancestor::note[1]">
          <xsl:call-template name="gettstamp.ges"/>
  ...
  <xsl:template match="fermata" mode="stage1">
    <!-- Fermata -->
    <!-- <xsl:if test="@default-y | @default-x | @relative-y | @relative-x"> -->
    <!-- The dir element is only created when the fermata has placement attributes!
           Fermatas without placement attributes are recorded in the fermata attribute. -->
    <!-- Perhaps font attributes should trigger this as well? -->
    <fermata>
      <xsl:attribute name="place">
        <xsl:choose>
    ...
    <xsl:choose>
      <xsl:when test="beam[@number='1']='begin'">
        <xsl:variable name="beamlevel">
          <!-- <xsl:value-of select="(count(preceding-sibling::*[beam[@number='1']='begin']) + 1) - count(preceding-sibling::*[beam[@number='1']='end'])"/> -->
          <xsl:value-of
      ...
      <xsl:when test="beam[@number ='1']='continue'">
        <xsl:variable name="beamlevel">
          <!-- <xsl:value-of select="count(preceding-sibling::*[beam[@number='1']='begin']) - count(preceding-sibling::*[beam[@number='1']='end'])"/> -->
          <xsl:value-of
  ...
  <xsl:template name="articulations">
    ...
    <xsl:for-each select="notations/articulations/*">
      <artic>
        <xsl:choose>
          <xsl:when test="name()='accent'">
            <xsl:attribute name="value">acc</xsl:attribute>
          ...
          <xsl:when test="name()='strong-accent'">
            <xsl:attribute name="value">marc</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='staccato'">
            <xsl:attribute name="value">stacc</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='tenuto'">
            <xsl:attribute name="value">ten</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='detached-legato'">
            <xsl:attribute name="value">loure</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='staccatissimo'">
            <xsl:attribute name="value">stacciss</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
    ...
    <xsl:for-each
      ...
      <artic>
        <xsl:choose>
          <xsl:when test="name()='up-bow'">
            <xsl:attribute name="value">upbow</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='down-bow'">
            <xsl:attribute name="value">dnbow</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='harmonic'">
            <xsl:attribute name="value">harm</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='snap-pizzicato'">
            <xsl:attribute name="value">snap</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='tap'">
            <xsl:attribute name="value">tap</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='pluck'">
            <xsl:attribute name="value">pluck</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='double-tongue'">
            <xsl:attribute name="value">dbltongue</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='triple-tongue'">
            <xsl:attribute name="value">trpltongue</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='bend'">
            <xsl:attribute name="value">bend</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='heel'">
            <xsl:attribute name="value">heel</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='toe'">
            <xsl:attribute name="value">toe</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
          ...
          <xsl:when test="name()='fingernails'">
            <xsl:attribute name="value">fingernail</xsl:attribute>
            <xsl:if test="@placement != ''">
              <xsl:attribute name="place">
                <xsl:value-of select="@placement"/>
              </xsl:attribute>
  ...
  <xsl:template match="rest" priority="2" mode="stage2">
    ...
    <xsl:choose>
      <xsl:when
        ...
        <xsl:variable name="ppq">
          <xsl:value-of
            select="number(preceding::staffdef[@n=$thisstaff and @midi.div][1]/@midi.div)"
          />
        </xsl:variable>
        <xsl:variable name="meter.unit">
          <xsl:choose>
        ...
        <!-- <xsl:comment>THISSTAFF=<xsl:value-of select="$thisstaff"/></xsl:comment>
        <xsl:comment>PPQ=<xsl:value-of select="$ppq"/></xsl:comment>
        <xsl:comment>METER.UNIT=<xsl:value-of select="$meter.unit"/></xsl:comment>
        <xsl:comment>METER.COUNT=<xsl:value-of select="$meter.count"/></xsl:comment>
        <xsl:comment>MEASUREDUR=<xsl:value-of select="$measuredur"/></xsl:comment> -->

        <xsl:choose>
          <xsl:when test="@dur.ges=$measuredur">
            <!-- This is a full-measure rest, copy attributes from rest element, except
                 dur and tstamp.ges. -->
            <mrest>
              <xsl:copy-of select="@xml:id"/>
              <xsl:copy-of
                ...
                <xsl:attribute name="vo">
                  ...
                  <xsl:choose>
                    ...
                    <xsl:when test="$clefshape='G' and $clefline='2'">
                      <xsl:choose>
                        <xsl:when
                          test="$display-step='E' and $display-octave='3'"
                          >-11</xsl:when>
                        <xsl:when
                          test="$display-step='F' and $display-octave='3'"
                          >-10</xsl:when>
                        <xsl:when
                          test="$display-step='G' and $display-octave='3'"
                          >-9</xsl:when>
                        <xsl:when
                          test="$display-step='A' and $display-octave='3'"
                          >-8</xsl:when>
                        <xsl:when
                          test="$display-step='B' and $display-octave='3'"
                          >-7</xsl:when>
                        <xsl:when
                          test="$display-step='C' and $display-octave='4'"
                          >-6</xsl:when>
                        <xsl:when
                          test="$display-step='D' and $display-octave='4'"
                          >-5</xsl:when>
                        <xsl:when
                          test="$display-step='E' and $display-octave='4'"
                          >-4</xsl:when>
                        <xsl:when
                          test="$display-step='F' and $display-octave='4'"
                          >-3</xsl:when>
                        <xsl:when
                          test="$display-step='G' and $display-octave='4'"
                          >-2</xsl:when>
                        <xsl:when
                          test="$display-step='A' and $display-octave='4'"
                          >-1</xsl:when>
                        <xsl:when
                          test="$display-step='B' and $display-octave='4'"
                          >0</xsl:when>
                        <xsl:when
                          test="$display-step='C' and $display-octave='5'"
                          >1</xsl:when>
                        <xsl:when
                          test="$display-step='D' and $display-octave='5'"
                          >2</xsl:when>
                        <xsl:when
                          test="$display-step='E' and $display-octave='5'"
                          >3</xsl:when>
                        <xsl:when
                          test="$display-step='F' and $display-octave='5'"
                          >4</xsl:when>
                        <xsl:when
                          test="$display-step='G' and $display-octave='5'"
                          >5</xsl:when>
                        <xsl:when
                          test="$display-step='A' and $display-octave='5'"
                          >6</xsl:when>
                        <xsl:when
                          test="$display-step='B' and $display-octave='5'"
                          >7</xsl:when>
                        <xsl:when
                          test="$display-step='C' and $display-octave='6'"
                          >8</xsl:when>
                        <xsl:when
                          test="$display-step='D' and $display-octave='6'"
                          >9</xsl:when>
                        <xsl:when
                          test="$display-step='E' and $display-octave='6'"
                          >10</xsl:when>
                        <xsl:when
                          test="$display-step='F' and $display-octave='6'"
                          >11</xsl:when>
                      </xsl:choose>
                    </xsl:when>
                    <!-- bass clef -->
                    <xsl:when test="$clefshape='F' and $clefline='4'">
                      <xsl:choose>
                        <xsl:when
                          test="$display-step='G' and $display-octave='1'"
                          >-11</xsl:when>
                        <xsl:when
                          test="$display-step='A' and $display-octave='1'"
                          >-10</xsl:when>
                        <xsl:when
                          test="$display-step='B' and $display-octave='1'"
                          >-9</xsl:when>
                        <xsl:when
                          test="$display-step='C' and $display-octave='2'"
                          >-8</xsl:when>
                        <xsl:when
                          test="$display-step='D' and $display-octave='2'"
                          >-7</xsl:when>
                        <xsl:when
                          test="$display-step='E' and $display-octave='2'"
                          >-6</xsl:when>
                        <xsl:when
                          test="$display-step='F' and $display-octave='2'"
                          >-5</xsl:when>
                        <xsl:when
                          test="$display-step='G' and $display-octave='2'"
                          >-4</xsl:when>
                        <xsl:when
                          test="$display-step='A' and $display-octave='2'"
                          >-3</xsl:when>
                        <xsl:when
                          test="$display-step='B' and $display-octave='2'"
                          >-2</xsl:when>
                        <xsl:when
                          test="$display-step='C' and $display-octave='3'"
                          >-1</xsl:when>
                        <xsl:when
                          test="$display-step='D' and $display-octave='3'"
                          >0</xsl:when>
                        <xsl:when
                          test="$display-step='E' and $display-octave='3'"
                          >1</xsl:when>
                    ...
                    <xsl:when test="$clefshape='C' and $clefline='2'">
                      <xsl:choose>
                        ...
                        <xsl:when
                          ...
                          >-2</xsl:when>
                        <xsl:when
                          test="$display-step='E' and $display-octave='r'"
                          >-1</xsl:when>
                        <xsl:when
                          test="$display-step='F' and $display-octave='4'"
                          >0</xsl:when>
          ...
          <xsl:otherwise>
            <!-- this is not a full-measure rest -->
            <xsl:copy>
              <xsl:copy-of
                select="@*[not(name()='meiform') and not(name()='beam')
                                   and not(name()='tstamp.ges')]"/>
